...
import net.mcreator.haegrilontest.world.dimension.OldworldDimension;
import net.mcreator.haegrilontest.itemgroup.UtilityItemGroup;

public class OldworldItem extends Item {
	@ObjectHolder("haegrilontest:oldworld")
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				OldworldDimension.portal.portalSpawn(world, pos);
