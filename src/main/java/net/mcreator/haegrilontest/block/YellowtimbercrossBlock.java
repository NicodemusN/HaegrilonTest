...
public class YellowtimbercrossBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:yellowtimbercross")
	public static final Block block = null;

	public YellowtimbercrossBlock(HaegrilontestModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellowtimbercross");
		}
