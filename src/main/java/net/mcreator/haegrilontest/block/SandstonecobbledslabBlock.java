...
public class SandstonecobbledslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonecobbledslab")
	public static final Block block = null;

	public SandstonecobbledslabBlock(HaegrilontestModElements instance) {
		super(instance, 584);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonecobbledslab");
		}
