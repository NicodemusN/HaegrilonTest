...
public class WhitetimberwestBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:whitetimberwest")
	public static final Block block = null;
	public WhitetimberwestBlock(HaegrilontestModElements instance) {
		super(instance, 151);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitetimberwest");
		}
