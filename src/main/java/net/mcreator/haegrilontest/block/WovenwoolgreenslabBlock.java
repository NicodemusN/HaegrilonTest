...
public class WovenwoolgreenslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolgreenslab")
	public static final Block block = null;
	public WovenwoolgreenslabBlock(HaegrilontestModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolgreenslab");
		}
