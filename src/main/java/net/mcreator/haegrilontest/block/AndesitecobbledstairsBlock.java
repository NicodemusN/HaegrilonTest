...
public class AndesitecobbledstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitecobbledstairs")
	public static final Block block = null;

	public AndesitecobbledstairsBlock(HaegrilontestModElements instance) {
		super(instance, 569);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("andesitecobbledstairs");
		}
