...
public class FloorcarvedBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:floorcarved")
	public static final Block block = null;
	public FloorcarvedBlock(HaegrilontestModElements instance) {
		super(instance, 486);
	}
