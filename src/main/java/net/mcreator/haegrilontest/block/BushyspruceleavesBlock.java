...
public class BushyspruceleavesBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:bushyspruceleaves")
	public static final Block block = null;

	public BushyspruceleavesBlock(HaegrilontestModElements instance) {
		super(instance, 283);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("bushyspruceleaves");
		}
