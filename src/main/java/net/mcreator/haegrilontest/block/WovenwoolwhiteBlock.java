...
public class WovenwoolwhiteBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolwhite")
	public static final Block block = null;
	public WovenwoolwhiteBlock(HaegrilontestModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolwhite");
		}
