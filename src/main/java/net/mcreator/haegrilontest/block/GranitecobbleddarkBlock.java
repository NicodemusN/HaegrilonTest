...
public class GranitecobbleddarkBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:granitecobbleddark")
	public static final Block block = null;

	public GranitecobbleddarkBlock(HaegrilontestModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitecobbleddark");
		}
