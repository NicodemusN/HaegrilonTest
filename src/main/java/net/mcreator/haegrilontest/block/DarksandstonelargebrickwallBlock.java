...
public class DarksandstonelargebrickwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:darksandstonelargebrickwall")
	public static final Block block = null;

	public DarksandstonelargebrickwallBlock(HaegrilontestModElements instance) {
		super(instance, 582);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("darksandstonelargebrickwall");
		}
