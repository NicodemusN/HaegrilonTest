...
public class TudorbrickslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:tudorbrickslab")
	public static final Block block = null;

	public TudorbrickslabBlock(HaegrilontestModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tudorbrickslab");
		}
