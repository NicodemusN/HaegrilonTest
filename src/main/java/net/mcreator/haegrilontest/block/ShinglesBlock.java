...
public class ShinglesBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:shingles")
	public static final Block block = null;
	public ShinglesBlock(HaegrilontestModElements instance) {
		super(instance, 91);
	}
