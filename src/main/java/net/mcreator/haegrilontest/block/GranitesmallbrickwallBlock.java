...
public class GranitesmallbrickwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:granitesmallbrickwall")
	public static final Block block = null;
	public GranitesmallbrickwallBlock(HaegrilontestModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("granitesmallbrickwall");
		}
