...
public class SmallbricktrapdoorBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:smallbricktrapdoor")
	public static final Block block = null;
	public SmallbricktrapdoorBlock(HaegrilontestModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("smallbricktrapdoor");
		}
