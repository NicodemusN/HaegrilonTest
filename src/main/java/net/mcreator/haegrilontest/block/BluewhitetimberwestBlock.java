...
public class BluewhitetimberwestBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:bluewhitetimberwest")
	public static final Block block = null;
	public BluewhitetimberwestBlock(HaegrilontestModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluewhitetimberwest");
		}
