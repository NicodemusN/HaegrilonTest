...
public class Floorcarved2Block extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:floorcarved_2")
	public static final Block block = null;
	public Floorcarved2Block(HaegrilontestModElements instance) {
		super(instance, 487);
	}
