...
public class DarkparquetBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:darkparquet")
	public static final Block block = null;

	public DarkparquetBlock(HaegrilontestModElements instance) {
		super(instance, 592);
	}
