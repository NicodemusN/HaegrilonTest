...
public class BronzewallOxidizedBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:bronzewall_oxidized")
	public static final Block block = null;
	public BronzewallOxidizedBlock(HaegrilontestModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("bronzewall_oxidized");
		}
