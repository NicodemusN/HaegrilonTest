...
public class WovenwoolblueslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolblueslab")
	public static final Block block = null;
	public WovenwoolblueslabBlock(HaegrilontestModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolblueslab");
		}
