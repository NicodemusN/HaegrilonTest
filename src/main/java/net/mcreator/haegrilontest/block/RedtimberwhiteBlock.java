...
public class RedtimberwhiteBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:redtimberwhite")
	public static final Block block = null;

	public RedtimberwhiteBlock(HaegrilontestModElements instance) {
		super(instance, 263);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redtimberwhite");
		}
