...
public class BrickoaktimberwestBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:brickoaktimberwest")
	public static final Block block = null;
	public BrickoaktimberwestBlock(HaegrilontestModElements instance) {
		super(instance, 262);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brickoaktimberwest");
		}
