...
public class GreenrooftileswallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:greenrooftileswall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("greenrooftileswall");
		}
