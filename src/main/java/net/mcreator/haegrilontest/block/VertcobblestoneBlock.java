...
public class VertcobblestoneBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:vertcobblestone")
	public static final Block block = null;
	public VertcobblestoneBlock(HaegrilontestModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("vertcobblestone");
		}
