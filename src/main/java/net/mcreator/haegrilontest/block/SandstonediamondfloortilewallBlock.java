...
public class SandstonediamondfloortilewallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonediamondfloortilewall")
	public static final Block block = null;

	public SandstonediamondfloortilewallBlock(HaegrilontestModElements instance) {
		super(instance, 591);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonediamondfloortilewall");
		}
