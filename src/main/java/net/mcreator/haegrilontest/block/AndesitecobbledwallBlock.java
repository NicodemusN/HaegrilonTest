...
public class AndesitecobbledwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitecobbledwall")
	public static final Block block = null;

	public AndesitecobbledwallBlock(HaegrilontestModElements instance) {
		super(instance, 570);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("andesitecobbledwall");
		}
