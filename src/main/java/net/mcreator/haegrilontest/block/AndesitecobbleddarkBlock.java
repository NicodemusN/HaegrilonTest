...
public class AndesitecobbleddarkBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitecobbleddark")
	public static final Block block = null;

	public AndesitecobbleddarkBlock(HaegrilontestModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitecobbleddark");
		}
