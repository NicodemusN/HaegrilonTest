...
public class RosebushwhiteBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:rosebushwhite")
	public static final Block block = null;
	public RosebushwhiteBlock(HaegrilontestModElements instance) {
		super(instance, 214);
