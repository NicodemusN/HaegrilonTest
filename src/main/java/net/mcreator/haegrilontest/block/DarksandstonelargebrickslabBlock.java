...
public class DarksandstonelargebrickslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:darksandstonelargebrickslab")
	public static final Block block = null;

	public DarksandstonelargebrickslabBlock(HaegrilontestModElements instance) {
		super(instance, 581);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("darksandstonelargebrickslab");
		}
