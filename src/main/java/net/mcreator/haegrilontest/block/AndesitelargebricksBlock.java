...
public class AndesitelargebricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitelargebricks")
	public static final Block block = null;

	public AndesitelargebricksBlock(HaegrilontestModElements instance) {
		super(instance, 40);
	}
