...
public class CushionBlock extends HaegrilontestModElements.ModElement {
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 2, 3, 2), makeCuboidShape(14, 0, 0, 16, 3, 2), makeCuboidShape(14, 0, 14, 16, 3, 16),
					makeCuboidShape(0, 0, 14, 2, 3, 16), makeCuboidShape(0, 3, 0, 16, 8, 16)).withOffset(offset.x, offset.y, offset.z);
		}
