...
public class BluetimberwhiteeastBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:bluetimberwhiteeast")
	public static final Block block = null;

	public BluetimberwhiteeastBlock(HaegrilontestModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluetimberwhiteeast");
		}
