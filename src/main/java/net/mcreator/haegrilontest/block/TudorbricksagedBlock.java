...
public class TudorbricksagedBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:tudorbricksaged")
	public static final Block block = null;
	public TudorbricksagedBlock(HaegrilontestModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tudorbricksaged");
		}
