...
public class ThatchmossywallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:thatchmossywall")
	public static final Block block = null;
	public ThatchmossywallBlock(HaegrilontestModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("thatchmossywall");
		}
