...
public class WhiteoaktimberwestBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:whiteoaktimberwest")
	public static final Block block = null;
	public WhiteoaktimberwestBlock(HaegrilontestModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whiteoaktimberwest");
		}
