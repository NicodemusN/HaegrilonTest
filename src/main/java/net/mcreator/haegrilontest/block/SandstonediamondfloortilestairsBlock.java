...
public class SandstonediamondfloortilestairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonediamondfloortilestairs")
	public static final Block block = null;

	public SandstonediamondfloortilestairsBlock(HaegrilontestModElements instance) {
		super(instance, 589);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonediamondfloortilestairs");
		}
