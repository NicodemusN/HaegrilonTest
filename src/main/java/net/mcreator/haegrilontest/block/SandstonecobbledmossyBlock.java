...
public class SandstonecobbledmossyBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonecobbledmossy")
	public static final Block block = null;

	public SandstonecobbledmossyBlock(HaegrilontestModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonecobbledmossy");
		}
