...
public class Polishedgranite2Block extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:polishedgranite_2")
	public static final Block block = null;

	public Polishedgranite2Block(HaegrilontestModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polishedgranite_2");
		}
