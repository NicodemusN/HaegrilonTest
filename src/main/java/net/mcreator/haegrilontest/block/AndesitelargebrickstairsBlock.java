...
public class AndesitelargebrickstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitelargebrickstairs")
	public static final Block block = null;

	public AndesitelargebrickstairsBlock(HaegrilontestModElements instance) {
		super(instance, 571);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("andesitelargebrickstairs");
		}
