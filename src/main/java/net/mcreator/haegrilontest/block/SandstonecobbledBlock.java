...
public class SandstonecobbledBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonecobbled")
	public static final Block block = null;

	public SandstonecobbledBlock(HaegrilontestModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonecobbled");
		}
