...
public class SandstonesmallbrickwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonesmallbrickwall")
	public static final Block block = null;

	public SandstonesmallbrickwallBlock(HaegrilontestModElements instance) {
		super(instance, 579);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonesmallbrickwall");
		}
