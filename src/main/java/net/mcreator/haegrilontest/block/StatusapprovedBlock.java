...
public class StatusapprovedBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:statusapproved")
	public static final Block block = null;
	public StatusapprovedBlock(HaegrilontestModElements instance) {
		super(instance, 266);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("statusapproved");
		}
