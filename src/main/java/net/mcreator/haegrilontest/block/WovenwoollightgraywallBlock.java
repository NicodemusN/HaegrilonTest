...
public class WovenwoollightgraywallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoollightgraywall")
	public static final Block block = null;

	public WovenwoollightgraywallBlock(HaegrilontestModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoollightgraywall");
		}
