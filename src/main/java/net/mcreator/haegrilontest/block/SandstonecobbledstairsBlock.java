...
public class SandstonecobbledstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonecobbledstairs")
	public static final Block block = null;

	public SandstonecobbledstairsBlock(HaegrilontestModElements instance) {
		super(instance, 583);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonecobbledstairs");
		}
