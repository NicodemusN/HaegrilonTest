...
public class BronzefenceoxidizedBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:bronzefenceoxidized")
	public static final Block block = null;
	public BronzefenceoxidizedBlock(HaegrilontestModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("bronzefenceoxidized");
		}
