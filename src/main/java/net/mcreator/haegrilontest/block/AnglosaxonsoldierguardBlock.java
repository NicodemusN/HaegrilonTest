...
public class AnglosaxonsoldierguardBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:anglosaxonsoldierguard")
	public static final Block block = null;
	public AnglosaxonsoldierguardBlock(HaegrilontestModElements instance) {
		super(instance, 460);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("anglosaxonsoldierguard");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				AnglosaxonsoldierguardOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
