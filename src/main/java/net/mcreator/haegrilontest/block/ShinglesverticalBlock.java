...
public class ShinglesverticalBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:shinglesvertical")
	public static final Block block = null;
	public ShinglesverticalBlock(HaegrilontestModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("shinglesvertical");
		}
