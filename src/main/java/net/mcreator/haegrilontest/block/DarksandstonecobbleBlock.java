...
public class DarksandstonecobbleBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:darksandstonecobble")
	public static final Block block = null;

	public DarksandstonecobbleBlock(HaegrilontestModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darksandstonecobble");
		}
