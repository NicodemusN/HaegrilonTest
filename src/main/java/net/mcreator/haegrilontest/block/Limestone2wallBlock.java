...
public class Limestone2wallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:limestone_2wall")
	public static final Block block = null;

	public Limestone2wallBlock(HaegrilontestModElements instance) {
		super(instance, 344);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("limestone_2wall");
		}
