...
public class PolishedgranitedarkBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:polishedgranitedark")
	public static final Block block = null;

	public PolishedgranitedarkBlock(HaegrilontestModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polishedgranitedark");
		}
