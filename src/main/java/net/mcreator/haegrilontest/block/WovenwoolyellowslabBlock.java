...
public class WovenwoolyellowslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolyellowslab")
	public static final Block block = null;
	public WovenwoolyellowslabBlock(HaegrilontestModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolyellowslab");
		}
