...
public class Wheel1Block extends HaegrilontestModElements.ModElement {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case WEST :
					return VoxelShapes.or(makeCuboidShape(14, 0, 16, 16, 16, 0))
							...
							.withOffset(offset.x, offset.y, offset.z);
				case UP :
					return VoxelShapes.or(makeCuboidShape(0, 2, 0, 16, 0, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case DOWN :
					return VoxelShapes.or(makeCuboidShape(0, 14, 16, 16, 16, 0))
