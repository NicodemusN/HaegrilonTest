...
public class WovenwoolbluestairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolbluestairs")
	public static final Block block = null;
	public WovenwoolbluestairsBlock(HaegrilontestModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolbluestairs");
		}
