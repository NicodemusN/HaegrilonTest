...
public class WhitetimbercrossBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:whitetimbercross")
	public static final Block block = null;

	public WhitetimbercrossBlock(HaegrilontestModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitetimbercross");
		}
