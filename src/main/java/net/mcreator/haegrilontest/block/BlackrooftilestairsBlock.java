...
public class BlackrooftilestairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:blackrooftilestairs")
	public static final Block block = null;

	public BlackrooftilestairsBlock(HaegrilontestModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blackrooftilestairs");
		}
