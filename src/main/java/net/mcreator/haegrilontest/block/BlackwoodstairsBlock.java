...
public class BlackwoodstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:blackwoodstairs")
	public static final Block block = null;
	public BlackwoodstairsBlock(HaegrilontestModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blackwoodstairs");
		}
