...
public class TimberbeamwestBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:timberbeamwest")
	public static final Block block = null;
	public TimberbeamwestBlock(HaegrilontestModElements instance) {
		super(instance, 481);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("timberbeamwest");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				TimberwestchangeProcedure.executeProcedure($_dependencies);
			}
