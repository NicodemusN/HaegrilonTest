...
public class GranitesmallbrickstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:granitesmallbrickstairs")
	public static final Block block = null;
	public GranitesmallbrickstairsBlock(HaegrilontestModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("granitesmallbrickstairs");
		}
