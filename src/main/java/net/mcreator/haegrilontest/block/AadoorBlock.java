...
public class AadoorBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:aadoor")
	public static final Block block = null;

	public AadoorBlock(HaegrilontestModElements instance) {
		super(instance, 199);
	}
