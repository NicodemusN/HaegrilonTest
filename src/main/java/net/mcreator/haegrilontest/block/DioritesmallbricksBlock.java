...
public class DioritesmallbricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:dioritesmallbricks")
	public static final Block block = null;

	public DioritesmallbricksBlock(HaegrilontestModElements instance) {
		super(instance, 33);
	}
