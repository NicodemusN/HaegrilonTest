...
public class WhiteoaktimberBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:whiteoaktimber")
	public static final Block block = null;

	public WhiteoaktimberBlock(HaegrilontestModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whiteoaktimber");
		}
