...
public class SandstonediamondfloortilesBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonediamondfloortiles")
	public static final Block block = null;

	public SandstonediamondfloortilesBlock(HaegrilontestModElements instance) {
		super(instance, 588);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonediamondfloortiles");
		}
