...
public class DioritelargebrickslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:dioritelargebrickslab")
	public static final Block block = null;

	public DioritelargebrickslabBlock(HaegrilontestModElements instance) {
		super(instance, 575);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dioritelargebrickslab");
		}
