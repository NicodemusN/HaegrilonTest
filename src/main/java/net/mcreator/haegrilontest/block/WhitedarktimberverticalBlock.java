...
public class WhitedarktimberverticalBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:whitedarktimbervertical")
	public static final Block block = null;

	public WhitedarktimberverticalBlock(HaegrilontestModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitedarktimbervertical");
		}
