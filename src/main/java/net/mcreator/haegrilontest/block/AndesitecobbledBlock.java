...
public class AndesitecobbledBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitecobbled")
	public static final Block block = null;

	public AndesitecobbledBlock(HaegrilontestModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitecobbled");
		}
