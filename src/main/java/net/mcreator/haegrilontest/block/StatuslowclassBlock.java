...
public class StatuslowclassBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:statuslowclass")
	public static final Block block = null;
	public StatuslowclassBlock(HaegrilontestModElements instance) {
		super(instance, 247);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("statuslowclass");
		}
