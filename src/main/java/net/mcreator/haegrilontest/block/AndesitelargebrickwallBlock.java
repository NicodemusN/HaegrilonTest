...
public class AndesitelargebrickwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitelargebrickwall")
	public static final Block block = null;

	public AndesitelargebrickwallBlock(HaegrilontestModElements instance) {
		super(instance, 573);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("andesitelargebrickwall");
		}
