...
public class PolishedgranitelargebricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:polishedgranitelargebricks")
	public static final Block block = null;

	public PolishedgranitelargebricksBlock(HaegrilontestModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polishedgranitelargebricks");
		}
