...
public class AndesitelargebrickslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitelargebrickslab")
	public static final Block block = null;

	public AndesitelargebrickslabBlock(HaegrilontestModElements instance) {
		super(instance, 572);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("andesitelargebrickslab");
		}
