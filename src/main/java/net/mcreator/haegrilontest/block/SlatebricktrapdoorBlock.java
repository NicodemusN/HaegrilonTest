...
public class SlatebricktrapdoorBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:slatebricktrapdoor")
	public static final Block block = null;

	public SlatebricktrapdoorBlock(HaegrilontestModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("slatebricktrapdoor");
		}
