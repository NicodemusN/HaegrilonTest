...
public class DioritelargebrickstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:dioritelargebrickstairs")
	public static final Block block = null;

	public DioritelargebrickstairsBlock(HaegrilontestModElements instance) {
		super(instance, 574);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dioritelargebrickstairs");
		}
