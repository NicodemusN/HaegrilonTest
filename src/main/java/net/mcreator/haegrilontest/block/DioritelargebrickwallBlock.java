...
public class DioritelargebrickwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:dioritelargebrickwall")
	public static final Block block = null;

	public DioritelargebrickwallBlock(HaegrilontestModElements instance) {
		super(instance, 576);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("dioritelargebrickwall");
		}
