...
public class TableBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:table")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 13, 0, 16, 16, 16), makeCuboidShape(6, 0, 6, 10, 13, 10)).withOffset(offset.x, offset.y,
					offset.z);
		}
