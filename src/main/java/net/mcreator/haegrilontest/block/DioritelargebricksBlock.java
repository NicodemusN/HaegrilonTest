...
public class DioritelargebricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:dioritelargebricks")
	public static final Block block = null;

	public DioritelargebricksBlock(HaegrilontestModElements instance) {
		super(instance, 32);
	}
