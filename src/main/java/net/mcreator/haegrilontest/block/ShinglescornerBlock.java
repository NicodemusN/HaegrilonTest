...
public class ShinglescornerBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:shinglescorner")
	public static final Block block = null;
	public ShinglescornerBlock(HaegrilontestModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("shinglescorner");
		}
