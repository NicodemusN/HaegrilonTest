...
public class MuddycobblecornerBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:muddycobblecorner")
	public static final Block block = null;

	public MuddycobblecornerBlock(HaegrilontestModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("muddycobblecorner");
		}
