...
public class BlueslatecornerBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:blueslatecorner")
	public static final Block block = null;
	public BlueslatecornerBlock(HaegrilontestModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("blueslatecorner");
		}
