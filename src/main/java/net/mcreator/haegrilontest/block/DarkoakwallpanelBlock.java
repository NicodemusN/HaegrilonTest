...
public class DarkoakwallpanelBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:darkoakwallpanel")
	public static final Block block = null;
	public DarkoakwallpanelBlock(HaegrilontestModElements instance) {
		super(instance, 490);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkoakwallpanel");
		}
