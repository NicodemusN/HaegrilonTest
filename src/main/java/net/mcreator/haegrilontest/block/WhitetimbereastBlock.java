...
public class WhitetimbereastBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:whitetimbereast")
	public static final Block block = null;
	public WhitetimbereastBlock(HaegrilontestModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitetimbereast");
		}
