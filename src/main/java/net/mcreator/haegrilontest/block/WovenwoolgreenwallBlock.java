...
public class WovenwoolgreenwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolgreenwall")
	public static final Block block = null;
	public WovenwoolgreenwallBlock(HaegrilontestModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolgreenwall");
		}
