...
public class SandstonediamondfloortileslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonediamondfloortileslab")
	public static final Block block = null;

	public SandstonediamondfloortileslabBlock(HaegrilontestModElements instance) {
		super(instance, 590);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonediamondfloortileslab");
		}
