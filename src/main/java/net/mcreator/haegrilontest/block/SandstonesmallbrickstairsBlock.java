...
public class SandstonesmallbrickstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonesmallbrickstairs")
	public static final Block block = null;

	public SandstonesmallbrickstairsBlock(HaegrilontestModElements instance) {
		super(instance, 577);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonesmallbrickstairs");
		}
