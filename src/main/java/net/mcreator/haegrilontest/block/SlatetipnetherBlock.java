...
public class SlatetipnetherBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:slatetipnether")
	public static final Block block = null;

	public SlatetipnetherBlock(HaegrilontestModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("slatetipnether");
		}
