...
public class DirtlayerBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:dirtlayer")
	public static final Block block = null;
	public DirtlayerBlock(HaegrilontestModElements instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				DirtlayerOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
