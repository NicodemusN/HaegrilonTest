...
import net.mcreator.haegrilontest.procedures.DanishsoldierattackOnBlockRightClickedProcedure;
...
public class DanishsoldierattackBlock extends HaegrilontestModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("danishsoldierattack");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(DanishsoldierguardBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DanishsoldierguardBlock.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			DanishsoldierattackOnBlockRightClickedProcedure.executeProcedure(Stream
