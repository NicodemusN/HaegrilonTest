...
public class SandstonesmallbrickslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonesmallbrickslab")
	public static final Block block = null;

	public SandstonesmallbrickslabBlock(HaegrilontestModElements instance) {
		super(instance, 578);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonesmallbrickslab");
		}
