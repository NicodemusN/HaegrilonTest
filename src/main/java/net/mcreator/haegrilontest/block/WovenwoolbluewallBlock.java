...
public class WovenwoolbluewallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolbluewall")
	public static final Block block = null;

	public WovenwoolbluewallBlock(HaegrilontestModElements instance) {
		super(instance, 164);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolbluewall");
		}
