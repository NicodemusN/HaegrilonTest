...
public class ThatchgraycrossstitchwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:thatchgraycrossstitchwall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("thatchgraycrossstitchwall");
		}
