...
public class WovenwoolredslabBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolredslab")
	public static final Block block = null;
	public WovenwoolredslabBlock(HaegrilontestModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolredslab");
		}
