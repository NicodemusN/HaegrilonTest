...
public class WovenwoolredwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolredwall")
	public static final Block block = null;
	public WovenwoolredwallBlock(HaegrilontestModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolredwall");
		}
