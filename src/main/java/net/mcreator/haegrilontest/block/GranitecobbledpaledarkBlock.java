...
public class GranitecobbledpaledarkBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:granitecobbledpaledark")
	public static final Block block = null;

	public GranitecobbledpaledarkBlock(HaegrilontestModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitecobbledpaledark");
		}
