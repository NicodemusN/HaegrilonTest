...
public class HoppersmallsmoothbricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:hoppersmallsmoothbricks")
	public static final Block block = null;
	public HoppersmallsmoothbricksBlock(HaegrilontestModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("hoppersmallsmoothbricks");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(6, 0, 6, 10, 4, 10), makeCuboidShape(4, 5, 4, 12, 10, 12), makeCuboidShape(0, 10, 0, 16, 16, 16))
