...
public class SandstonecobbledwallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonecobbledwall")
	public static final Block block = null;

	public SandstonecobbledwallBlock(HaegrilontestModElements instance) {
		super(instance, 585);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstonecobbledwall");
		}
