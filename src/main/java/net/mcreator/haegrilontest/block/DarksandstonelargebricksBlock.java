...
public class DarksandstonelargebricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:darksandstonelargebricks")
	public static final Block block = null;

	public DarksandstonelargebricksBlock(HaegrilontestModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darksandstonelargebricks");
		}
