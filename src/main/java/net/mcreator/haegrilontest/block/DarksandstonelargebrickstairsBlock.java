...
public class DarksandstonelargebrickstairsBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:darksandstonelargebrickstairs")
	public static final Block block = null;

	public DarksandstonelargebrickstairsBlock(HaegrilontestModElements instance) {
		super(instance, 580);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("darksandstonelargebrickstairs");
		}
