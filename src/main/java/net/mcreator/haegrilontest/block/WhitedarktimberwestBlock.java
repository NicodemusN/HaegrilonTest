...
public class WhitedarktimberwestBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:whitedarktimberwest")
	public static final Block block = null;
	public WhitedarktimberwestBlock(HaegrilontestModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitedarktimberwest");
		}
