...
public class DanishsoldierguardBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:danishsoldierguard")
	public static final Block block = null;
	public DanishsoldierguardBlock(HaegrilontestModElements instance) {
		super(instance, 441);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("danishsoldierguard");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				DanishsoldierguardOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
