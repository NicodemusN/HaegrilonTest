...
public class BrowntimberarchBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:browntimberarch")
	public static final Block block = null;

	public BrowntimberarchBlock(HaegrilontestModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("browntimberarch");
		}
