...
public class BluewhitetimberverticalBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:bluewhitetimbervertical")
	public static final Block block = null;
	public BluewhitetimberverticalBlock(HaegrilontestModElements instance) {
		super(instance, 252);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluewhitetimbervertical");
		}
