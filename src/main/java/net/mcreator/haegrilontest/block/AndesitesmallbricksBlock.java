...
public class AndesitesmallbricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitesmallbricks")
	public static final Block block = null;

	public AndesitesmallbricksBlock(HaegrilontestModElements instance) {
		super(instance, 41);
	}
