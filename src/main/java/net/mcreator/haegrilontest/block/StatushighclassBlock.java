...
public class StatushighclassBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:statushighclass")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("statushighclass");
		}
