...
public class SmallbrickscornerBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:smallbrickscorner")
	public static final Block block = null;
	public SmallbrickscornerBlock(HaegrilontestModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("smallbrickscorner");
		}
