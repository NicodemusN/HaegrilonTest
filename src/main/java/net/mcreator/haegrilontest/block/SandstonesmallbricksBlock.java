...
public class SandstonesmallbricksBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:sandstonesmallbricks")
	public static final Block block = null;

	public SandstonesmallbricksBlock(HaegrilontestModElements instance) {
		super(instance, 18);
	}
