...
public class GranitecobblewallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:granitecobblewall")
	public static final Block block = null;
	public GranitecobblewallBlock(HaegrilontestModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("granitecobblewall");
		}
