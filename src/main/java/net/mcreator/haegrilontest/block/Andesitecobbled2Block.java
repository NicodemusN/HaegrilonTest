...
public class Andesitecobbled2Block extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:andesitecobbled_2")
	public static final Block block = null;

	public Andesitecobbled2Block(HaegrilontestModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitecobbled_2");
		}
