...
public class WovenwoolwhitewallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:wovenwoolwhitewall")
	public static final Block block = null;
	public WovenwoolwhitewallBlock(HaegrilontestModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wovenwoolwhitewall");
		}
