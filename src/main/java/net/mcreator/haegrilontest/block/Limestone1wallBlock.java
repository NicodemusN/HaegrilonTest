...
public class Limestone1wallBlock extends HaegrilontestModElements.ModElement {
	@ObjectHolder("haegrilontest:limestone_1wall")
	public static final Block block = null;

	public Limestone1wallBlock(HaegrilontestModElements instance) {
		super(instance, 321);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("limestone_1wall");
		}
